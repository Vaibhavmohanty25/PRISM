...
@router.get(
    "/projects/{project_name}/activities/{activity_name}/predictive-summary",
    response_model=ActivityPredictiveSummary,
)
def get_activity_predictive_summary(
    ...
    _require_project(service, project_name)
    result = service.analyze_activity_predictive_summary(
        project_name,
        activity_name,
    )
