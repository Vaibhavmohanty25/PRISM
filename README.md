...
| GET | `/api/v1/projects/{project_name}/activities/{activity_name}/predictive-summary` | Unified activity predictive facade |
| GET | `/api/v1/projects/{project_name}/predictive-summary` | Canonical project-level predictive summary |
